...
class AppColorConstants {
  ...
  static const Color scafoldBackGroundColor = Color(0xffc5b097);
  static const Color cardColor = Color(0xffC4A897);
  static const Color containerColor = Color(0xffF2F1EE);
  static const Color appBarColor = Color(0xffEAD0C2);
